...
- **Notes:** Closes T-509 routing item #1 (local-ml-engineer v1 prompt lever). Recall-only lever — precision (the success metric) unaffected. Awaiting commit (chore/feat/review per repo convention) + human sign-off before `done`.
